...
```yaml
- generic [ref=e3]:
  - heading "Couldn't find story matching 'summary-dssummarycard--default'." [level=1] [ref=e4]
  ...
  - list [ref=e6]:
    - listitem [ref=e7]:
      ...
      - link "Decorators documentation" [ref=e9]:
    ...
    - listitem [ref=e14]:
      ...
      - link "Environment Variables documentation" [ref=e16]:
